    ...
    const renderPagination = () => {
        ...
        return (
            <div className="flex justify-end items-center gap-2 py-3 px-2 select-none">
                <button
                    className="liquid-glass px-3 py-1 rounded-xl text-sm text-emerald-700 font-semibold shadow-glass transition hover:scale-105 disabled:opacity-40"
                    ...
                    typeof p === 'number' ? (
                        <button
                            ...
                            className={`px-3 py-1 rounded-xl mx-1 font-semibold shadow-glass transition text-base leading-tight
                                    ...
                                    : 'text-gray-600 hover:bg-emerald-100/40 hover:text-emerald-700'}
																						`}
                            style={{ minWidth: 28 }}
                ...
                <button
                    className="liquid-glass text-sm px-3 py-1 rounded-xl text-emerald-700 font-semibold shadow-glass transition hover:scale-105 disabled:opacity-40"
